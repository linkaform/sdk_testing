...
def test_turn_happy_path(accesos_api):
    """
    ...
    turn_data = get_turn_data(accesos_api, {
    ...
    try:
        start_turn_data = start_turn(accesos_api, {
            "location": "Planta Monterrey",
            "area": "Caseta Principal",
            "employee_list": [],
            "fotografia": [{
        ...
        end_turn_data = end_turn(accesos_api, {
            "location": "Planta Monterrey", 
            "area": "Caseta Principal",
